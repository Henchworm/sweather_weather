...
RSpec.describe "request for background image" do
  it "returns JSON response with image details", :vcr do
    ...
    expect(parsed[:data][:attributes][:url]).to eq("https://images.unsplash.com/photo-1511286148006-ec48824e3282?ixid=MnwzMDc4ODF8MHwxfHNlYXJjaHwxfHxkZW52ZXIlMkNjb3NreWxpbmV8ZW58MHx8fHwxNjQ2NjE4OTM2&ixlib=rb-1.2.1")
